						...
						>
							...
							>
								<div>
									<button
										type="button"
										class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-opacity-60 bg-minerva-purple text-base font-medium text-white hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-minerva-purple sm:ml-3 sm:w-auto sm:text-sm"
										@click="handleTemplateChoice"
									>
										Use Selected Template
									</button>
									<button
										type="button"
										class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-minerva-purple sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
										@click="closeModal"
										ref="cancelButtonRef"
									>
										Cancel
								...
								<div>
									<p class="mt-2 text-gray-500">
										No README in this repo! Add one using a
										template.
									</p>
									<h1
												...
												>
													...
													>
														<section
															...
															class="bg-gray-200 min-w-0 flex-1 h-full flex flex-col"
														>
															<div
																class="min-h-0 flex-1 overflow-y-auto"
															>
																<div
																	class="bg-white pt-5 pb-6 shadow"
																>
																	<div
																		class="px-4 sm:flex sm:justify-between sm:items-baseline sm:px-6 lg:px-8"
																	>
																		<div
																			class="sm:w-0 sm:flex-1"
																		>
																			<h1
																				id="template-heading"
																			...
																			>
																				<div>
																					<a
																						...
																						"
																						target="_blank"
																						class="-my-2 p-2 rounded-full bg-white flex items-center text-gray-400 hover:text-minerva-purple"
																					>
																						<span
																							class="sr-only"
																							>Open
...
const templates = [
	...
	},
	{
		...
		description:
			'A detailed README template to get you started writing awesome instructions and documentation for your projects. Perfect for personal and open-source projects.',
	},
	{
		id: 3,
		...
		description:
			'Another awesome README template to kickstart your projects. Perfect for personal and collaborative projects.',
	},
	{
		id: 4,
	...
	},
	{
		...
		description:
			'Yet another picture-perfect GitHub profile README example.',
	},
	{
		id: 6,
	...
	},
	{
		...
		description:
			'You can give instructions for how to report a security vulnerability in your project by adding a security policy to your repository. A must have for open-source projects.',
	},
	{
		id: 8,
		name: 'Blank',
